import {
  ...
  import "../../flowCategoria/eliminarCategoria/customEliminarCategoria.css"
  
  export const CustomEliminarGrado = ({ open, onClose, categoria, onConfirm, loading }) => {
        ...
        <DialogContent sx={{ pt: 2 }}>
          <div className="warning-container">
            ...
            <Typography className='titleDialog' variant="h6">
              ...
              ¿Está seguro que desea eliminar el grado?</Typography>
          </div>
  
          <Typography className='titleDialog' variant="body2" color="text.secondary">
            Esta acción no se puede deshacer. El grado será eliminado.
          </Typography>
  
          <Paper className="details-paper" elevation={0}>
            <Typography variant="subtitle1" gutterBottom>
              Detalles del grado de la categoría:
            </Typography>
            ...
            <div className="detail-row">
              <Typography className="detail-label">Grados:</Typography>
              <Typography>{categoria.rango_grados}</Typography>
            </div>
        </div>
          </Paper>
