...
class Competidor extends Seeder{
    public function run(){
        ...
        // Verificar si hay cursos y colegios disponibles
        ...
        // Función para obtener el ID de un colegio de manera segura
        ...
        // Función para obtener el ID de un curso de manera segura
        ...
        // Función para obtener el ID de una ubicación de manera segura
