    ...
    public function run(){
        ...
        foreach ($areas as $area) {
            $cronogramas[] = [
                ...
                'nombre_evento' => 'Primera fase ' . $area->nombre,
                'descripcion' => 'Primera fase de competencia para el área de ' . $area->nombre,
            ...
            $cronogramas[] = [
                ...
                'descripcion' => 'Segunda fase de competencia para el área de ' . $area->nombre,
